...
const appId = 'pink-store-v1';

// --- PRODUTOS INICIAIS (apenas para seed no Firestore se quiser usar depois) ---
...
export default function App() {
  ...
  // Carregar apenas o carrinho do Firestore
  useEffect(() => {
    if (!user) return;
            ...
            <div className="md:col-span-5 flex flex-col">
              ...
              <div className="flex items-center gap-4 mb-6 border-b border-gray-100 pb-6">
                ...
                <span className="text-sm font-bold text-gray-500">
                  ({selectedProduct.reviews ?? 0} avaliações)
                </span>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex gap-4">
                  <div className="w-32 flex items-center border-2 border-gray-200 rounded h-14">
                    <button onClick={() => setQty(Math.max(1, qty - 1))} className="h-full px-4 hover:bg-gray-100 text-gray-600">
                      <Minus size={16}/>
                    </button>
                    <span className="flex-1 text-center font-bold text-lg">{qty}</span>
                    <button onClick={() => setQty(qty + 1)} className="h-full px-4 hover:bg-gray-100 text-gray-600">
                      <Plus size={16}/>
                    </button>
                  </div>
                  <Button
                ...
                <Button
                  ...
                  onClick={() => { addToCart(selectedProduct, qty); setIsCartOpen(false); setCurrentRoute('checkout'); }}
                >
                  COMPRAR AGORA
                </Button>
              </div>
                ...
                return (
                  <button 
                    ...
                    className={`px-8 py-4 font-bold uppercase tracking-wider text-sm border-b-2 transition-colors whitespace-nowrap ${
                      activeTab === key ? 'border-[#E91E63] text-black' : 'border-transparent text-gray-400 hover:text-gray-600'
                    }`}
                  >
                    {tab}
                  </button>
            ...
            <div className="prose max-w-none text-gray-600 leading-relaxed">
              {activeTab === 'desc' && (
                <div className="animate-fade-in">
                  ...
                  <p>
                    Desenvolvido com tecnologia exclusiva, este produto entrega resultados visíveis desde a primeira aplicação. 
                    Sua fórmula contém ativos concentrados que agem profundamente.
                  </p>
                </div>
              )}
              {activeTab === 'aval' && (
  ...
  const CheckoutPage = () => {
    const [formData, setFormData] = useState({ 
      email: '', name: '', address: '', number: '', cardName: '', cardNumber: '', cvv: '' 
    });
      ...
      return (
        <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
          ...
          <p className="text-gray-600 mb-8 max-w-md">
            Obrigado por comprar na Pink Store. Você receberá um e-mail com os detalhes.
          </p>
          <Button onClick={() => { setPaymentStatus('idle'); setCurrentRoute('home'); }}>
            Continuar Comprando
          </Button>
        </div>
      );
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded border border-gray-200">
              ...
              <div className="flex gap-3 mb-6">
                <button className="flex-1 py-4 border-2 border-[#E91E63] bg-[#E91E63]/5 text-[#E91E63] font-bold rounded flex flex-col items-center justify-center gap-1 text-xs uppercase">
                  <CreditCard size={20} /> Cartão de Crédito
                </button>
                <button className="flex-1 py-4 border border-gray-200 text-gray-400 font-bold rounded flex flex-col items-center justify-center gap-1 text-xs uppercase hover:bg-gray-50">
                  PIX (-5%)
                </button>
              </div>
              <div className="space-y-4">
                <input
                  ...
                  className="w-full bg-gray-50 border-gray-200 border p-3 rounded text-sm outline-none focus:border-[#E91E63]"
                  onChange={handleChange}
                />
                <input
                  name="cardName"
          ...
          <div className="md:col-span-1">
            <div className="bg-gray-50 p-6 rounded border border-gray-200 sticky top-24">
                ...
                >
                  <div
                    className={`w-5 h-5 border-2 rounded flex items-center justify-center transition-colors ${
                      bumpAdded ? 'bg-[#E91E63] border-[#E91E63]' : 'border-gray-300'
                    }`}
                  >
              ...
              <Button
                ...
                onClick={() => handlePaymentProcess(formData)}
        ...
        {cart.length > 0 && (
          <div className="p-5 bg-gray-50 border-t border-gray-200">
            ...
            <Button
              ...
              onClick={() => { setIsCartOpen(false); setCurrentRoute('checkout'); }}
            >
              Finalizar Compra
            </Button>
          </div>
